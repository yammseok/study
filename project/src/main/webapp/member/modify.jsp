...
<form action="/mem/edit" method="post">
		<div class="outbox">
            <div class="id" style="margin-top: 27px;"><input type="email" name="email" id="mid" value="${mvo.email }" readonly></div>
            <div class="id"><input type="text" name="nick_name" id="mid" value="${mvo.nick_name }" placeholder="닉네임"></div>
            <div><input type="password" placeholder="비밀번호" name="pwd" value="${mvo.pwd }" id="mpass"></div>
